...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 26 Jun 2023 pada 10.37
-- Versi server: 8.0.33
...
CREATE TABLE `users` (
  ...
  `sign_img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `documents`
  MODIFY `document_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
